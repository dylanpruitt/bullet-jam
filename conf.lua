...
function love.conf(t)
    ...
    t.window.title          = "Dylan's game :)"   -- The window title (string)
    t.window.icon           = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width          = gameWidth * scaleX  -- The window width (number)
    t.window.height         = gameHeight * scaleY -- The window height (number)
